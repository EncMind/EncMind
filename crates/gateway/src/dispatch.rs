...
pub async fn dispatch_method(
    ...
    match method {
        ...
        "sessions.archive" => handlers::sessions::handle_archive(state, params, req_id).await,
        "sessions.unarchive" => handlers::sessions::handle_unarchive(state, params, req_id).await,
        "sessions.export" => handlers::sessions::handle_export(state, params, req_id).await,
        "sessions.tag_add" => handlers::sessions::handle_tag_add(state, params, req_id).await,
        "sessions.tag_remove" => handlers::sessions::handle_tag_remove(state, params, req_id).await,
        "sessions.tags" => handlers::sessions::handle_tags(state, params, req_id).await,
